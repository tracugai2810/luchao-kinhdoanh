...
function renderCaptureHTML(data) {
    ...
    target.innerHTML = `
        <div class="info-header">
            ...
            <div style="display: flex; flex-wrap: wrap; width: 80px; height: 80px; border: 3px double #c41e3a; color: #c41e3a; font-family: 'Charm', cursive, serif; font-size: 20px; font-weight: 700; border-radius: 2px; opacity: 0.9; margin-left: auto; padding: 2px; box-sizing: border-box; background: rgba(196, 30, 58, 0.01); line-height: 1;">
                <div style="width: 50%; height: 50%; display: flex; align-items: center; justify-content: center; border-right: 1px dashed rgba(196, 30, 58, 0.15); border-bottom: 1px dashed rgba(196, 30, 58, 0.15);">Đại</div>
                <div style="width: 50%; height: 50%; display: flex; align-items: center; justify-content: center; border-bottom: 1px dashed rgba(196, 30, 58, 0.15);">Đạo</div>
                <div style="width: 50%; height: 50%; display: flex; align-items: center; justify-content: center; border-right: 1px dashed rgba(196, 30, 58, 0.15);">Chí</div>
                <div style="width: 50%; height: 50%; display: flex; align-items: center; justify-content: center;">Giản</div>
            </div>
        </div>
